...
### 校级比赛
- 新生赛在当年 $12$ 月份的第一个星期六，仅面向大一新生，不限专业。允许集训队内高年级队员打星参与，不允许非集训队内人员打星参与（若被集训队参赛队员邀请打星无此限制）。正式选手颁发奖状，允许转专业加分。
- 校赛在当年 $4$ 月份第一个星期六，面向所有年级（包括研究生），不限专业，允许集训队内高年级队员打星参与，不允许非集训队内人员打星参与（若被集训队参赛队员邀请打星无此限制）。正式选手颁发奖状。
### 晋级赛
- 一般在寒暑假集训的开始和结束各举行一次，由满足参赛队员晋级要求的正式队员参与。在 ICPC/CCPC 网络赛结束后，ICPC/CCPC 区域赛开始前，再进行一次。
### 淘汰赛
- 寒假结束时，于新学期初进行，面向所有现役队员，在淘汰赛中解出题数不符合要求（具体要求在赛后公布）的队员将被踢出集训队，失去集训队队员资格。允许再次入队，需要和教练以及队长沟通，需要得到教练以及**至少两位**队长的同意。
### 天梯赛
- 一般在当年 $4$ 月份第二个星期日（具体以官网为准），在当年 $3$ 月份会对现役队员进行排位赛，选拔队员参加。
- 校二类赛事，允许综测加分；不加保研分。
### 蓝桥杯
- 省赛一般在当年 $4$ 月份第二个星期六（具体以官网为准），报名时间在上一年 $12$ 月左右，由学校统一报名，根据队员性质给予不同程度的报名费减免。
- 国赛一般在当年 $6$ 月份第二个星期六（具体以官网为准）。
- 校二类竞赛，允许综测加分；不加保研分。
### 百度之星
- 举办时间不确定，以当年官方通知为准。
- 省赛线上举办，国赛在北京举办。
- 校二类竞赛，允许综测加分；不加保研分。
### 码蹄杯（本科组）
- 举办时间一般在当年 $8$ 月（具体以官网为准）
<!-- - 校二类竞赛（暂未申报），允许综测加分；不加保研分。 -->
### 睿抗（Raicmo）编程赛道
- 举办时间一般在当年 $7$ 月（具体以官网为准）
- 校二类竞赛，允许综测加分；不加保研分。
### 浙江省大学生程序设计竞赛
- 一般在当年 $4$ 月份最后一个星期六（具体以官方通知为准）。
- 现役队员在教练同意的基础上自行组队；教练会依据 $3$ 月份排位赛以及平时表现把控队伍组成，原则上队内水平不应相差过大。具体报名将在集训队群内通知。
- 校一类竞赛，允许保研及综测加分。
### ICPC/CCPC 邀请赛
- 全国各地线下举办，自行组队参加，视情况允许报销部分或全部报名费、交通及住宿费用。
- 原则上每只队伍比赛次数 $\le 1$。
- 既不是校二类，也不是校一类。
### ICPC/CCPC 区域赛
- 全国各地线下举办，视情况允许报销部分或全部名费、交通及住宿费用。
...
自 2026.1.1 起，邀请赛一般不报销，特别优秀情况的特别处理。
...
注：免交通不含市内交通（打车、地铁），每个**队员**只能进行一次报销。打星不报销（不论奖项）。
